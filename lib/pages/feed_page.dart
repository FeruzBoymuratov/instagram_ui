...
class _FeedPageState extends State<FeedPage> {
  List<Story> _stories = [
    ...
    Story("assets/images/img_3.png", "Sylvester"),
    Story("assets/images/img_4.png", "Lavina"),
    Story("assets/images/img_5.png", "Jazmin"),
    Story("assets/images/img_4.png", "Sylvester"),
    Story("assets/images/img_3.png", "Lavina"),
  ];
  ...
  List<Post> _posts = [
    ...
    Post(
        ...
        postImage: "assets/images/img_5.png",
        caption: "Consequatur nihil aliquid omnis consequatur."),
    Post(
        username: "Mariano",
        userImage: "assets/images/img_2.png",
        postImage: "assets/images/img_3.png",
        caption: "Consequatur nihil aliquid omnis consequatur."),
